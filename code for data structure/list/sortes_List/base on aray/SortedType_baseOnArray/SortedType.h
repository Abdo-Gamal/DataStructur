#pragma once
#ifndef SORTED            // want to #endif  at the end of program
#define SORTED
...
//const int MAX_ITEMS=5;            /////////////////<=========imprtant 
class SortedType
{
public:
	SortedType();
	...
	int GetLength() const;
	int Getmax_Item() const;
	// Function: Determines the number of elements in list.
	// Pre:  List has been initialized.
	// Post: Function value = number of elements in list

	ItemType GetItem(ItemType item, bool& found);
	bool GetItemI(ItemType item);
	...
	void PutItemand_throwException(ItemType item);
